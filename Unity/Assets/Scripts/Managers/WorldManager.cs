...
public class WorldManager : MonoBehaviour
{
	...
	[SerializeField] private AnimationCurve nearSpawnRadius;
	...
	public List<FivegPoint> FiveGees = new List<FivegPoint>();
	...
	public void SpawnGemNear(GameObject obj)
	{
		Instantiate(gemPrefabs[Random.Range(0, gemPrefabs.Count)], new Vector3(obj.transform.position.x + nearSpawnRadius.Evaluate(Random.Range(0f, 1f)), 0f, obj.transform.position.z + nearSpawnRadius.Evaluate(Random.Range(0f, 1f))), Quaternion.identity);
	}
